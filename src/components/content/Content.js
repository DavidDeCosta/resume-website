...
import myImage from 'C:/ResumeProject/resume-website/src/components/content/profile3.jpg';
      ...
      <div className='rightBox'>
        <div className='about'>
          ...
          <p>Programming is not only interesting, it is important for the future. I have always been competative due to growing up 
            playing sports. Iv'e also always been a big fan of chess and puzzles. Software development is like a puzzle the way you have
        ...
        <div className='projects'>
          ...
          <div className='box'>
            <h4>Data Mining</h4>
              <p>
                Worked in a team of 3 where we found a large dataset containing over 80,000 rows. Using excel and different
                python scripts we cleaned the noisy data and created more attributes for each tuple. Using an application called
